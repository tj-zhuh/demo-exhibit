...
define(function (require) {
    ...
    function drawFactoryList(data) {
        ...
        for (var i = 0; i < data[0].StructOut.length; i++) {
            ...
            var box_head = $("<div class='box-head'><img id='box-img' src='../images/1_15.png' /><span>" + item.SubConfigName + "</span></div>");
        ...
        //setInterval(dao.queryGraphData(getCondition(), loadData), 3000);
        dao.queryGraphData(getCondition(), loadData);
    }
    ...
    function location(data) {
        ...
        var offsetTopOut = (panelHeight - countOut * 170) > 0 ? (panelHeight - countOut * 170) / 2 : 0;
        var offsetTopIn = (panelHeight - countIn * 170) > 0 ? (panelHeight - countIn * 170) / 2 : 0;
    ...
    function drawVerticalLine(data) {
        ...
        var topOut = parseFloat($(".factoy-list-out").css("top")) + 135;
        var topIn = parseFloat($(".factoy-list-in").css("top")) + 135;
        var heightOut = (countOut - 1) * 170;
        var heightIn = (countIn - 1) * 170;
